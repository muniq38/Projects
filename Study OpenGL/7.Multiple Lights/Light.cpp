...
int main() {
	...
	Shader CubeShader("Shader/vertexMultiple.vs", "Shader/fragmMultiple.fs");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		for(int i=1; i<=4; i++){
			modelMat = mat4(1.0);
			modelMat = translate(modelMat, LightPos[i]);
		...
		CubeShader.setFloat("material.alpha", 64.0);

		// LightSource 객체들의 정보 전달 (굳이 이런방법밖에 없나 싶음)
		// 1번 (Directional)
		CubeShader.setVec3("L[0].dir", vec3(-0.2, -1.0, -0.3));
		CubeShader.setVec3("L[0].ambCof", vec3(0.05)); 
		CubeShader.setVec3("L[0].diffCof", vec3(0.4));
		CubeShader.setVec3("L[0].specCof", vec3(0.5));
		// 2번~5번 (Point)
		CubeShader.setVec3("L[1].pos", LightPos[1]);
		CubeShader.setVec3("L[1].ambCof", vec3(0.05));
		CubeShader.setVec3("L[1].diffCof", vec3(0.5));
		CubeShader.setVec3("L[1].specCof", vec3(0.8));
		CubeShader.setFloat("L[1].A", 0.032);
		CubeShader.setFloat("L[1].B", 0.09);
		CubeShader.setFloat("L[1].C", 1.0);

		CubeShader.setVec3("L[2].pos", LightPos[2]);
		CubeShader.setVec3("L[2].ambCof", vec3(0.05));
		CubeShader.setVec3("L[2].diffCof", vec3(0.8));
		CubeShader.setVec3("L[2].specCof", vec3(0.8));
		CubeShader.setFloat("L[2].A", 0.032);
		CubeShader.setFloat("L[2].B", 0.09);
		CubeShader.setFloat("L[2].C", 1.0);

		CubeShader.setVec3("L[3].pos", LightPos[3]);
		CubeShader.setVec3("L[3].ambCof", vec3(0.05));
		CubeShader.setVec3("L[3].diffCof", vec3(0.8));
		CubeShader.setVec3("L[3].specCof", vec3(0.8));
		CubeShader.setFloat("L[3].A", 0.032);
		CubeShader.setFloat("L[3].B", 0.09);
		CubeShader.setFloat("L[3].C", 1.0);

		CubeShader.setVec3("L[4].pos", LightPos[4]);
		CubeShader.setVec3("L[4].ambCof", vec3(0.05));
		CubeShader.setVec3("L[4].diffCof", vec3(0.8));
		CubeShader.setVec3("L[4].specCof", vec3(0.8));
		CubeShader.setFloat("L[4].A", 0.032);
		CubeShader.setFloat("L[4].B", 0.09);
		CubeShader.setFloat("L[4].C", 1.0);
		// 6번 (SpotLight)
		CubeShader.setVec3("L[5].pos", camPos);
		CubeShader.setVec3("L[5].dir", camTarg);
		CubeShader.setVec3("L[5].ambCof", vec3(0.0));
		CubeShader.setVec3("L[5].diffCof", vec3(1.0));
		CubeShader.setVec3("L[5].specCof", vec3(0.7));
		CubeShader.setFloat("L[5].A", 0.032);
		CubeShader.setFloat("L[5].B", 0.09);
		CubeShader.setFloat("L[5].C", 1.0);
		CubeShader.setFloat("L[5].Cutoff", cos(Rad(12.5)));
		CubeShader.setFloat("L[5].outCutoff", cos(Rad(17.5)));
